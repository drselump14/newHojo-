...
{
    [super viewDidLoad];
    member = [NSArray arrayWithObjects:@"村上",@"山根",@"細野",@"井上",@"清水", nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.accessoryType = UITableViewCellAccessoryCheckmark;
    NSString *theMember = [member objectAtIndex:indexPath.row];
    [self.delegate memberPickerViewController:self didSelectMember:theMember];
}
